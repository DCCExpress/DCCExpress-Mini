...
(() => {
  ...
  // src/turnout.ts
  var Turnout = class extends HTMLElement {
    constructor() {
      super();
      this.address = 0;
      this.angle = 270;
  ...
  var TurnoutRightElement = class extends Turnout {
    draw() {
      super.draw();
      if (this.ctx) {
        this.ctx.save();
  ...
  var TurnoutLeftElement = class extends TurnoutRightElement {
    constructor() {
      super();
      this.angle = 90;
    }
  ...
  var LocoPanel = class extends HTMLElement {
    ...
    openTurnoutsModal() {
      ...
      this.turnouts.forEach((turnout) => {
        ...
        const elem = turnout.isLeft ? document.createElement("turnout-left-element") : document.createElement("turnout-right-element");
        ...
        elem.addEventListener("click", () => {
          ...
          if (to) {
            ...
            Api.setTurnout(to);
            const elem2 = this.shadowRoot.getElementById(`turnout-${to.address}`);
            if (elem2) {
              elem2.isClosed = to.isClosed != to.isInverted;
            }
          }
        });
